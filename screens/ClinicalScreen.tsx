...
import { UploadIcon, CheckCircleIcon, LightBulbIcon } from '../components/Icons';
    ...
    return (
        <div className="p-4 sm:p-6 max-w-4xl mx-auto pb-32">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-soft border border-brand-gray-50 relative overflow-hidden animate-fade-in group hover:shadow-soft-lg transition-all duration-500">
                ...
                <p className="text-brand-gray-600 mb-10 font-bold text-sm leading-relaxed max-w-md">Nuestra IA extraerá automáticamente niveles de salud clave de su documento.</p>
                ...
                {successMessage && <div className="mt-6 p-6 bg-brand-soft-green text-brand-green rounded-3xl border border-brand-green/10 font-black text-center uppercase text-[10px] tracking-widest flex items-center justify-center gap-3"><CheckCircleIcon className="w-5 h-5" /> {successMessage}</div>}
            </div>
